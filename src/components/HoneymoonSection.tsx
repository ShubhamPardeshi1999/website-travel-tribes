...
export default function HoneymoonSection() {
  return (
    <section className="py-section-gap bg-[#0284c7]">
      <div className="px-grid-margin max-w-[1440px] mx-auto flex flex-col lg:flex-row items-center gap-16">
        <motion.div
        ...
        >
          <h2 className="font-section-heading-mobile md:font-section-heading text-section-heading-mobile md:text-section-heading mb-6">
            Romantic Escapes
          </h2>
          ...
          <button className="bg-[#FF6B35] text-on-primary font-label-bold text-label-bold px-8 py-4 rounded-full hover:bg-[#FF6B35]/90 transition-opacity cursor-pointer">
            Plan Your Honeymoon
          </button>
        </motion.div>
        ...
        <div className="lg:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
          <motion.div
            ...
            className="relative rounded-2xl overflow-hidden h-[350px] group"
          >
            <Image
          ...
          <motion.div
            ...
            className="relative rounded-2xl overflow-hidden h-[350px] group mt-0 md:mt-12"
          >
            <Image
